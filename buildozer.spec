...
title = BrainRootReader

# (str) Package name
package.name = brainroot

# (str) Package domain (needed for android/ios packaging)
package.domain = org.read

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
#source.include_exts = py,html,css,js,json,ico,png,svg,woff,woff2,map,pickle,tab,txt,onnx,mp4
...
source.exclude_dirs = bin, .venv, build, dist
...
requirements = python3,kivy, pyjnius,flask==2.2.2, werkzeug==2.2.2,nltk, regex, https://github.com/kvdroid/Kvdroid/archive/refs/heads/master.zip ,requests, pypdf,numpy,sherpa-onnx
...
icon.filename = %(source.dir)s/brainrootreadericon.png
...
#android.extra_manifest_xml = network_config.xml
